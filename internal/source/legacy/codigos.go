...
// meiosDePagamento são os valores de <paymentMethod><type>.
...
//
// Está deliberadamente vazio: a documentação pública do PagBank não traz mais a
...
// errada, o que é pior do que deixá-las com o código. Ao confirmar os valores
// numa conta real, acrescente-os aqui.
